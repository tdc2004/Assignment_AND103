...
import com.chinhdev.assignment_and103.Interface.GHNRequest;
import com.chinhdev.assignment_and103.Interface.GHNService;
import com.chinhdev.assignment_and103.R;
import com.chinhdev.assignment_and103.adapter.Adapter_Item_District_Select_GHN;
import com.chinhdev.assignment_and103.adapter.Adapter_Item_Province_Select_GHN;
import com.chinhdev.assignment_and103.adapter.Adapter_Item_Ward_Select_GHN;
import com.chinhdev.assignment_and103.databinding.ActivityLocationBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnOrder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(LocationActivity.this, OderSuccesActivity.class));
            }
        });
